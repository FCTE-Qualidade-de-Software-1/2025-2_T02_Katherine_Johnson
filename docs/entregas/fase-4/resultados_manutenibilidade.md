...
- SO, versões de ferramentas (ex.: SonarQube/Scanner, libs de cobertura), commit/branch analisado.
...
| --- | --- | --- | --- | --- |
| (ex.: Complexidade, Acoplamento, Ciclos, Cobertura, Docs) | | | | |
...
- Síntese do nível de Manutenibilidade.
